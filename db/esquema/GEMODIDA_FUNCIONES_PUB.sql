...
-- public.actualizar_configuracion_scraping(p_id_config integer, p_nombre_configuracion character varying, p_descripcion text, p_fuentes_activas integer[], p_palabras_clave_activas integer[], p_frecuencia_minutos integer, p_esta_activa boolean, p_configuracion_avanzada jsonb)
...
-- public.actualizar_configuracion_sistema(p_clave character varying, p_valor text, p_tipo character varying, p_descripcion text, p_es_sensible boolean)
...
-- public.actualizar_estadisticas(p_id_palabra integer)
...
-- public.actualizar_rol(p_id_rol integer, p_nombre_rol character varying, p_descripcion text, p_nivel_acceso integer, p_permisos_json jsonb, p_puede_crear_usuarios boolean, p_puede_ver_todas_sucursales boolean, p_esta_activo boolean)
...
-- public.actualizar_timestamp_modificacion()
...
-- public.actualizar_usuario(p_id_usuario uuid, p_correo character varying, p_nombre_completo character varying, p_telefono character varying, p_id_rol integer, p_id_suc integer, p_esta_activo boolean)
CREATE OR REPLACE FUNCTION public.actualizar_usuario(p_id_usuario uuid, p_correo character varying, p_nombre_completo character varying, p_telefono character varying, p_id_rol integer, p_id_suc integer, p_esta_activo boolean)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
-- public.add_column_if_not_exists(tab text, col text, col_def text)
...
-- public.agregar_usuario(p_correo character varying, p_nombre_completo character varying, p_rol_id integer, p_sucursal_id integer)
...
-- public.buscar_palabras_clave(p_busqueda text DEFAULT NULL::text, p_id_usuario uuid DEFAULT NULL::uuid, p_limite integer DEFAULT 10, p_desplazamiento integer DEFAULT 0)
...
-- public.contar_registros(p_tabla text)
...
-- public.crear_encuesta_personalizada(p_titulo character varying, p_descripcion text, p_tipo_encuesta character varying, p_id_sucursal integer, p_estructura_json jsonb, p_creado_por uuid)
...
-- public.crear_nuevo_usuario_sistema(p_email text, p_password text, p_nombre_completo text, p_codigo_rol text, p_codigo_grupo text, p_id_sucursal integer)
...
-- public.crear_planificacion_trabajo(p_titulo character varying, p_descripcion text, p_tipo_trabajo character varying, p_id_sucursal integer, p_id_responsable uuid, p_fecha_inicio date, p_fecha_fin date, p_presupuesto_estimado numeric, p_creado_por uuid)
...
-- public.crear_usuario_completo(p_correo character varying, p_nombre_completo character varying, p_telefono character varying, p_id_grupo integer, p_id_rol integer, p_id_sucursal integer, p_creado_por uuid)
CREATE OR REPLACE FUNCTION public.crear_usuario_completo(p_correo character varying, p_nombre_completo character varying, p_telefono character varying, p_id_grupo integer, p_id_rol integer, p_id_sucursal integer, p_creado_por uuid)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
-- public.generar_reporte(p_titulo text, p_descripcion text, p_tipo_reporte text, p_parametros jsonb, p_id_usuario_solicitante uuid)
...
-- public.generar_reporte_consolidado(p_fecha_inicio timestamp without time zone, p_fecha_fin timestamp without time zone)
...
-- public.generar_reporte_consolidado_sucursal(p_id_sucursal integer, p_fecha_inicio date, p_fecha_fin date)
...
-- public.log_proceso(p_tipo_proceso character varying, p_estado character varying, p_mensaje text, p_detalles text DEFAULT NULL::text, p_id_usuario uuid DEFAULT NULL::uuid, p_metadatos jsonb DEFAULT '{}'::jsonb, p_ip_origen inet DEFAULT NULL::inet)
...
-- public.marcar_notificacion_leida(p_id_notificacion integer, p_id_usuario uuid)
...
-- public.obtener_actividades(p_limite integer DEFAULT 10, p_desplazamiento integer DEFAULT 0)
...
-- public.obtener_actividades_filtradas(p_id_sucursal integer, p_tipo_actividad character varying, p_estado character varying, p_fecha_inicio date, p_fecha_fin date, p_limite integer, p_desplazamiento integer)
...
-- public.obtener_actividades_usuario(p_id_usuario uuid, p_limite integer DEFAULT 10, p_desplazamiento integer DEFAULT 0)
...
-- public.obtener_alertas_activas(p_limite integer DEFAULT 10)
...
-- public.obtener_configuraciones_scraping()
...
-- public.obtener_configuraciones_sistema()
...
-- public.obtener_encuestas(p_limite integer DEFAULT 10, p_desplazamiento integer DEFAULT 0)
...
-- public.obtener_estadisticas_dashboard()
...
-- public.obtener_estadisticas_dashboard_sucursal(p_id_sucursal integer DEFAULT NULL::integer, p_fecha_inicio date DEFAULT (CURRENT_DATE - '30 days'::interval), p_fecha_fin date DEFAULT CURRENT_DATE)
...
-- public.obtener_estadisticas_departamentos(p_fecha_inicio date DEFAULT (CURRENT_DATE - '30 days'::interval), p_fecha_fin date DEFAULT CURRENT_DATE)
...
-- public.obtener_estadisticas_palabra(p_id_palabra integer, p_fecha_inicio timestamp with time zone DEFAULT (now() - '30 days'::interval), p_fecha_fin timestamp with time zone DEFAULT now())
...
-- public.obtener_estadisticas_por_periodo(p_id_palabra integer, p_tipo_periodo character varying DEFAULT 'day'::character varying, p_limite integer DEFAULT 30)
...
-- public.obtener_logs_todos(p_limite integer DEFAULT 10, p_desplazamiento integer DEFAULT 0, p_tipo_proceso text DEFAULT NULL::text)
...
-- public.obtener_notificaciones_usuario(p_id_usuario uuid, p_solo_no_leidas boolean DEFAULT false, p_limite integer DEFAULT 10)
...
-- public.obtener_palabras_clave_recientes(p_limite integer DEFAULT 10)
...
-- public.obtener_palabras_clave_todas(p_limite integer DEFAULT 10, p_desplazamiento integer DEFAULT 0)
...
-- public.obtener_permisos_usuario(p_user_id uuid)
...
-- public.obtener_reportes_pendientes(p_limite integer DEFAULT 10)
...
-- public.obtener_reportes_todos(p_limite integer DEFAULT 10, p_desplazamiento integer DEFAULT 0)
...
-- public.obtener_respuestas_encuesta(p_id_encuesta integer)
...
-- public.obtener_resultados_recientes(p_limite integer DEFAULT 10)
...
-- public.obtener_resultados_todos(p_limite integer DEFAULT 10, p_desplazamiento integer DEFAULT 0, p_id_palabra integer DEFAULT NULL::integer, p_sentimiento text DEFAULT NULL::text)
...
-- public.obtener_usuarios(p_limite integer DEFAULT 10, p_desplazamiento integer DEFAULT 0)
...
-- public.obtener_usuarios_activos(p_limite integer DEFAULT 10)
...
-- public.obtener_usuarios_completos(p_limite integer DEFAULT 50, p_desplazamiento integer DEFAULT 0)
...
-- public.usuario_tiene_permiso(p_usuario_id uuid, p_permiso text)
