...
-- Insertar en ddl_migrations_log
INSERT INTO ddl_migrations_log (mensaje)
VALUES ('Funcionalidad de reset de contraseña implementada - tabla tokens, funciones RPC y notificaciones');

COMMIT;</content>
<parameter name="filePath">D:\Proyectos\Web\GEMODIDA\db\Scripts_SQL\reset_password_functionality.sql